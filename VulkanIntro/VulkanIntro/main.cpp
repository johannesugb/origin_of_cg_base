...
private:
	void initVulkan() {
		...
		renderObject = new vkRenderObject((uint32_t)swapChainImages.size(), verticesQuad, indicesQuad, descriptorSetLayout, descriptorPool, textureSampler, textureImageView);
		//loadModel();
	...
	void cleanup() {
		...
		vkDestroyImageView(vkContext::instance().device, textureImageView, nullptr);
		vkDestroyImage(vkContext::instance().device, textureImage, nullptr);
		vkFreeMemory(vkContext::instance().device, textureImageMemory, nullptr);
		delete renderObject;
	...
	void loadModel() {
		...
		renderObject = new vkRenderObject((uint32_t)swapChainImages.size(), vertices, indices, descriptorSetLayout, descriptorPool, textureSampler, textureImageView);
	}
